...
def _discover_races() -> list[dict]:
    ...
    Returns list of dicts sorted by round (most recent first).
    """
    races = []
...
<h2 style="font-size:1.5rem; border:none; color:#fff; margin-top:0;">
  2026 F1 Championship Predictions
</h2>
<p style="color:#aaa;">
...
<p style="color:#666; font-size:0.85rem;">
  {n_races} race(s) · {n_reports} prediction update(s) · Last updated {datetime.utcnow().strftime("%Y-%m-%d %H:%M UTC")}
</p>
